...
// 显示欢迎信息
void showWelcome() {
    std::vector<std::string> ouc_welcome_content = {
        "\x1b[38;5;45m",
        ...
        "                                                             ",
        "╔════════════════════════════════════════════════════════════╗",
        "║           ———==== OUC 生存大冒险 " + std::string(OUCSurvSim_VERSION) + "   ====———           ║",
        "╚════════════════════════════════════════════════════════════╝",
        "\x1b[0m",
        "\x1b[38;5;8m",
        "================================== Hint ======================================",
        ...
        "",
        "Github: https://github.com/JEB-him/MUD-Game\x1b[0m",
    };
    for (auto line : ouc_welcome_content) {
