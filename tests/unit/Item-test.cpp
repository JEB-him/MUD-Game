...
TEST_CASE("Item function test", "[item]") {
    ...
    SECTION("compressed_crackers") { // CD
        ...
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_USED_COMPRESSED_CRACKER] == -10000);
        ...
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_USED_COMPRESSED_CRACKER] == 0);
        CHECK(protagonist.getBaseAttrs()[BasicValue::ProtagonistAttr::HEALTH] == 10);
        ...
        backpack.useFunctionOfItem(6, protagonist);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_USED_COMPRESSED_CRACKER] == 21);
        CHECK(protagonist.getBaseAttrs()[BasicValue::ProtagonistAttr::HEALTH] == 10);
    ...
    SECTION("nutritious_meals") {
        ...
        backpack.addItem("nutritious_meals");
        backpack.useFunctionOfItem(6, protagonist);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_USED_COMPRESSED_CRACKER] == 3);
    ...
    SECTION("energy_drink") { //buff punish
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_BUFF_ENERGY_DRINK] == -10000);
        ...
        backpack.useFunctionOfItem(6, protagonist);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_BUFF_ENERGY_DRINK] == 0);
        CHECK(protagonist.getBaseAttrs()[BasicValue::ProtagonistAttr::HEALTH] == 100);
        ...
        protagonist.addGameTime(3);
        backpack.useFunctionOfItem(6, protagonist);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_BUFF_ENERGY_DRINK] == 3);
    ...
    SECTION("milk") { // buff
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_BUFF_MILK] == -10000);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::INTELSCI_BOOST] == 0);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::INTELARTS_BOOST] == 0);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::INTELSCI_BOOST_RATE] == 1.0f);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::INTELARTS_BOOST_RATE] == 1.0f);
    ...
    SECTION("first_aid_kit") { // CD
        ...
        backpack.useFunctionOfItem(6, protagonist);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_USED_FIRST_AID_KIT] == 0);
        ...
        protagonist.addGameTime(18);
        backpack.useFunctionOfItem(6, protagonist);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_USED_FIRST_AID_KIT] == 21);
    ...
    SECTION("vitamins") { // buff
        ...
        backpack.addItem("vitamins");
        backpack.useFunctionOfItem(6, protagonist);
        CHECK(protagonist.getHiddenAttrs()[BasicValue::ProtagonistAttr::T_BUFF_VITAMINS] == 0);
